...
public class BillingDetailsAdapteryear extends RecyclerView.Adapter<BillingDetailsAdapteryear.ViewHolder> {
    ...
    public BillingDetailsAdapteryear(List<CombinedDetailsModel> billingDetailsList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rowmonthandyear, parent, false);
