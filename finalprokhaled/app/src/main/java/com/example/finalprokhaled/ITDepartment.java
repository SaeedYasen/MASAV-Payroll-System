...
import com.example.finalprokhaled.R;
...
public class ITDepartment extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ValueEventListener messagesValueEventListener = new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(com.example.finalprokhaled.ITDepartment.this, "נכשל בטעינת הצ'אט.", Toast.LENGTH_SHORT).show();
            }
        };
